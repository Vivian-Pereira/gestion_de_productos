...
function canBuyProduct() {
    ...
    const precioFinal = precioProducto - (precioProducto * descuento);
...
function checkUserNameType() {
    let userName = "Juan"; // Puedes cambiar el valor a lo que necesites
...
function checkDogIdIsString() {
    let dogId = "12345"; // Puedes cambiar el valor a lo que necesites
...
// Llama a las funciones para ejecutar el código
compareTenAndNine();
compareZeroAndZero();
compareSeven();
canBuyProduct();
